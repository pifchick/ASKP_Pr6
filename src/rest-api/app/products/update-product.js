jQuery(function($){
    ...
    $(document).on('click', '.update-product-button', function(){
        ...
        $.getJSON("http://localhost:4542/api/product/read_one.php?id=" + id, function(data){
            ...
            $.getJSON("http://localhost:4542/api/category/read.php", function(data){
    ...
    $(document).on('submit', '#update-product-form', function(){
        ...
        $.ajax({
            url: "http://localhost:4542/api/product/update.php",
            type : "POST",
